          ...
          <ul>
           <Link to={`/`} style={{color:"white", textDecoration:"none"}}>
            <li className="flex al g5 m10 text">
              <img className="invert" src="./svgs/home.svg" alt="home" />Home
            </li>
           </Link>
            <li className="flex al g5 m10 text">
              <img className="invert" src="./svgs/search.svg" alt="search" />Search
            </li>
          </ul>
        </div>
        ...
        <div className="library rounded m2 p2">
         ...
         <div className="left-footer m2  rounded">
            <div className="left-footer-box  flex g2">
              <div className="text"><a className="text" href="#">Legal</a></div>
              <div className="text"><a className="text" href="#">Safety & Privacy Center</a></div>
              <div className="text"><a className="text" href="#">Privacy Policy</a></div>
              <div className="text"><a className="text" href="#">Cookies</a></div>
              <div className="text"><a className="text" href="#">About Ads</a></div>
              <div className="text"><a className="text" href="#">Accessibility</a></div>
            </div>

            <div className="lang p10 m5">
              <button
                className="lang-btn bg-black flex al g5 rounded-btn p10"
              >
                <img className="invert" src="./svgs/language.svg" alt="language" />
                English
              </button>
            </div>
          </div> 
